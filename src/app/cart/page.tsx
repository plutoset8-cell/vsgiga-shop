                    ...
                    <div className="flex-1 w-full min-w-0">
                      ...
                      <div className="hidden md:grid grid-cols-4 gap-6 p-6 bg-white/[0.02] rounded-[2.5rem] border border-white/5 backdrop-blur-sm mb-10">
                        <div className="space-y-1.5 text-center">
                          ...
                          <p className="text-[11px] font-mono text-white/60 uppercase">OPIUM_v{idx + 1}</p>
                        </div>
                        <div className="space-y-1.5 border-l border-white/5 text-center">
                          <p className="text-[8px] font-black text-white/20 uppercase tracking-widest italic">Encryption</p>
                          <p className="text-[11px] font-mono text-[#ff007a] uppercase italic">AES_256</p>
                        </div>
                        <div className="space-y-1.5 border-l border-white/5 text-center">
                          <p className="text-[8px] font-black text-white/20 uppercase tracking-widest italic">Hash_Sum</p>
                          <p className="text-[11px] font-mono text-white/60 uppercase">SHA_2025</p>
                        </div>
                        <div className="space-y-1.5 border-l border-white/5 text-center">
                          <p className="text-[8px] font-black text-white/20 uppercase tracking-widest italic">Load</p>
                          <p className="text-[11px] font-mono text-green-500/60 uppercase">NOMINAL</p>
                        </div>
                      </div>
