        ...
        <main className="min-h-screen bg-black text-white pt-40 pb-32 px-8 relative overflow-hidden">
            ...
            {showPaymentModal && (
                <>
                    ...
                    >
                        <div
                            className="bg-[#0a0a0a] border border-white/10 p-8 rounded-[3rem] w-full max-w-md shadow-[0_0_100px_rgba(255,0,122,0.3)] relative"
                        ...
                        >
                            ...
                            <div className="flex justify-between items-center mb-8">
                                <div>
                                    ...
                                    <p className="text-white/30 text-[9px] uppercase font-bold tracking-widest mt-1 italic">Перевод по реквизитам</p>
                                </div>
                                <button
                                    onClick={() => setShowPaymentModal(false)}
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-white/5 border border-white/5 p-5 rounded-[2rem] text-center">
                                    ...
                                    <p className="text-4xl font-black text-[#ff007a] italic">{frozenPrice.toLocaleString()} ₽</p>
                                </div>
                                ...
                                <div className="relative text-center">
                                    ...
                                    <div className="relative bg-black border border-white/10 p-6 rounded-[2.5rem]">
                                        <p className="text-[9px] font-black uppercase tracking-[0.4em] text-[#ff007a] mb-2">КОД В КОММЕНТАРИЙ</p>
                                        <div className="flex items-center justify-center gap-3">
                                            <span className="text-5xl font-black italic text-white tracking-tighter">#{paymentCode}</span>
                                            <button
                                                onClick={() => {
                                                    navigator.clipboard.writeText(paymentCode);
                                                    addToast('КОД_СКОПИРОВАН', 'success');
                                                }}
                                ...
                                <div className="p-5 bg-white/5 border border-white/5 rounded-[2rem]">
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <button onClick={() => {
                                            ...
                                            addToast('НОМЕР_СКОПИРОВАН', 'success');
                                        }}>
                                            <Copy size={14} className="text-white/20 hover:text-white" />
                                        </button>
                                    </div>
                                    <p className="text-[8px] text-white/30 font-bold uppercase mt-1 tracking-widest">Банк: ОЗОН (СБП)</p>
                                </div>

                                {/* Предупреждение */}
                                <div className="bg-[#ff007a]/10 border border-[#ff007a]/20 p-4 rounded-2xl text-[8px] font-black uppercase tracking-wider text-[#ff007a] text-center">
                                    ОБЯЗАТЕЛЬНО УКАЖИТЕ КОД #{paymentCode} В КОММЕНТАРИИ. ИНАЧЕ ОПЛАТА НЕ БУДЕТ ЗАЧТЕНА.
                                </div>
