...
function OpiumStatusHUD() {
  ...
  return (
    <div className="hidden xl:block fixed left-10 bottom-10 z-[100] pointer-events-none">
      <AnimatePresence>
        {isVisible ? (
          <motion.div
            key="hud-panel"
          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              <div className="flex flex-col gap-1">
                ...
                <span className="text-[12px] text-[#ff007a] font-black italic uppercase tracking-tighter">DARK_AESTHETIC_MODE_ACTIVE</span>
              </div>
              <div className="flex flex-col gap-1">
          ...
          <motion.button
            ...
            className="pointer-events-auto w-10 h-10 bg-black/50 border border-[#ff007a]/30 rounded-full flex items-center justify-center text-[#ff007a] hover:bg-[#ff007a] hover:text-white transition-all shadow-[0_0_15px_rgba(255,0,122,0.2)]"
          >
            <Activity size={16} />
          </motion.button>
        )}
        ...
        <div className="flex flex-wrap gap-4 mb-24 bg-white/[0.03] border border-white/5 p-3 rounded-full w-fit backdrop-blur-3xl shadow-2xl">
          {CATEGORIES.map((cat) => (
            <button
              ...
              className={`px-12 py-5 rounded-full text-[10px] font-black tracking-[0.3em] uppercase transition-all duration-700 ${activeCategory === cat.id
              ...
              {filteredProducts.map((product: any) => (
                ...
                >
                  ...
                  <button
                    ...
                    className={`w-full py-6 rounded-3xl font-black uppercase text-[10px] tracking-[0.4em] italic transition-all active:scale-95 relative overflow-hidden ${addingId === product.id
                        ? 'bg-white text-black'
